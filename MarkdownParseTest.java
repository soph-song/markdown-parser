...
public class MarkdownParseTest {
    ...
    @Test
    public void snippet11Test() throws IOException {
        testHelper("snippet1.md", new String[]{});
    }

    @Test
    public void snippet12Test() throws IOException {
        testHelper("snippet12.md", new String[]{"`google.com"});
    }

    @Test
    public void snippet13Test() throws IOException {
        testHelper("snippet13.md", new String[]{"google.com"});
    }

    @Test
    public void snippet14Test() throws IOException {
        testHelper("snippet14.md", new String[]{"ucsd.`edu"});
    }
    ...
    @Test
    public void snippet2TestComplex() throws IOException {
        testHelper("snippet2new.md", new String[]{"a.com", "bang", "example.com"});
    }
